...
<meta charset="UTF-8">
<title>Affecter une reclamation</title>
...
<span class="material-icons text-primary">assignment_ind</span>

Affecter une reclamation
...
<form method="POST"
action="{{ route('reclamations.assign.store',$reclamation->id) }}"
class="space-y-5">
...
class="px-4 py-2 rounded-lg border border-slate-200 text-slate-600 hover:bg-slate-100">
