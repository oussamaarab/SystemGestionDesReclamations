...
<header class="h-14 bg-white border-b border-slate-200 flex items-center justify-between px-6">
    ...
    <a href="{{ route('services.index') }}"
       class="bg-slate-100 text-slate-700 px-3.5 py-2 rounded-lg flex items-center gap-1.5 font-semibold hover:bg-slate-200 text-sm shadow-sm">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-slate-500 mt-1">
                            Remplissez les champs ci-dessous pour ajouter un nouveau service.
                        </p>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text"
                               name="code"
                               value="{{ old('code') }}"
                               placeholder="Entrer le code du service"
                               class="w-full px-4 py-3 border border-slate-200 rounded-xl bg-slate-50 text-sm focus:border-primary focus:ring-2 focus:ring-primary/10">
